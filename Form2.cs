...
namespace WindowsFormsApp1
{
    public partial class Form2 : Form
    {
        public Form2()
        {
            ...
            label2.Text = Program.lang.GetLang().Registations.pochta;
            label3.Text = Program.lang.GetLang().Registations.pass;
            label4.Text = Program.lang.GetLang().Registations.pass_two;
